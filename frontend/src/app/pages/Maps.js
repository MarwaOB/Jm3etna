...
const Maps = () => {
  ...
  return (
    <div className="bg-white">
      <nav className="bg-[var(--my-green)] text-white py-2 px-12 flex justify-between items-center shadow-md mb-8">
        <Image 
          src={logo}
          alt="Logo" 
          width={80} 
      ...
      <div className="flex flex-row items-center justify-start gap-8 mb-8">
        <div className="flex flex-row items-center justify-between gap-4 px-12">
          ...
          <input
            ...
            className="w-80 min-w-[300px] px-8 py-2 rounded-3xl border-2 border-[var(--my-green)] focus:border-[var(--my-yellow)] focus:text-[var(--my-green)] focus:outline-none transition-colors duration-200"
          />
        ...
        <div className="relative">
          <select
            ...
            className="text-white p-2 border border-[var(--my-green)] rounded-3xl focus:border-[var(--my-green)] focus:outline-none bg-[var(--my-green)]"
          >
      ...
      <div className="grid grid-cols-3 gap-8 border-2 rounded-3xl mx-30 my-10 p-4">
      {restaurants.map((rest, index) => (
  <div key={index} className="p-4 border-2 rounded-3xl flex flex-col h-full shadow-md">
    {/* Image */}
    ...
    <div className="flex flex-col flex-grow mt-3 space-y-2">
      <h3 className="text-black font-[var(--my-lato)] text-lg flex items-center">
    ...
    <div className="mt-auto pt-3">
      <button 
        className="bg-[var(--my-green)] rounded-xl text-white p-2 w-full transition-transform transform hover:scale-105"
        onClick={() => window.open(`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(rest.name)}`, "_blank")}
      >
        Open in Google Maps
      </button>
    </div>
