...
const menuItems = [
  ...
  { name: "Contribute", icon: contributeIcon },
            ...
            >
              <div className="flex items-center justify-center w-10 h-10">
                <Image
                  ...
                  style={{
                    filter: isSelected 
                      ? "brightness(0) saturate(100%) invert(77%) sepia(54%) saturate(861%) hue-rotate(334deg) brightness(101%) contrast(101%)" // RGB(255,199,40) - Yellow
